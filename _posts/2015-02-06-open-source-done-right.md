...
After some pretty useless googling, I pinged a twitter message to [Glenn Block](https://www.twitter.com/gblock) which got the ball rolling.
...
While I knew of Glenn from his great work on the [Web API](https://www.asp.net/web-api) platform (among others), he is not someone who I had spoken to before.  However, due to his public contributions to [ScriptCS](https://github.com/scriptcs/scriptcs) I knew that he was the guy to ask first.
...
So thank you [Glenn Block](https://www.twitter.com/gblock), [Adam Ralph](https://www.twitter.com/adamralph) and everyone associated with [ScriptCS](https://github.com/scriptcs/scriptcs).